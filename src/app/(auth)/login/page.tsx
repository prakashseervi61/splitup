              ...
              <div>
                ...
                <div className="mt-1 flex">
                  ...
                  <input
                    ...
                    className="block w-full rounded-r-lg border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                    required
                    disabled={loading}
                    autoFocus
                  />
                ...
                <div className="mt-3 flex justify-between gap-2">
                  {otp.map((digit, i) => (
                    <input
                      ...
                      className="h-12 w-12 rounded-lg border border-gray-300 text-center text-lg font-semibold focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                      required
                      disabled={loading}
                      autoFocus={i === 0}
                    />
